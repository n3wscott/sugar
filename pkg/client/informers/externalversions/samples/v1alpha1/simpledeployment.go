...
import (
	...
	internalinterfaces "knative.dev/sugar/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "knative.dev/sugar/pkg/client/listers/samples/v1alpha1"
)
