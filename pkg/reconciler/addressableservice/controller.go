...
import (
	...
	addressableserviceinformer "knative.dev/sugar/pkg/client/injection/informers/samples/v1alpha1/addressableservice"
	addressableservicereconciler "knative.dev/sugar/pkg/client/injection/reconciler/samples/v1alpha1/addressableservice"
)
