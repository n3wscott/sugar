...
import (
	...
	simpledeploymentinformer "knative.dev/sugar/pkg/client/injection/informers/samples/v1alpha1/simpledeployment"
	simpledeploymentreconciler "knative.dev/sugar/pkg/client/injection/reconciler/samples/v1alpha1/simpledeployment"
)
